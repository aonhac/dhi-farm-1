    ...
    <StyledWrapper>
      <Card>
        ...
        <Footnote>
          ...
          <FootnoteValue>
            <PendingRewards />
            {' '}
            <span style={{ color: '#FFD201' }}>ALK</span>
          </FootnoteValue>
        </Footnote>
      </Card>
      <Spacer />
      <Card>
        ...
        <Footnote>
          ...
          <FootnoteValue>1,000 <span style={{ color: '#FFD201' }}>ALK</span></FootnoteValue>
        </Footnote>
      </Card>
    </StyledWrapper>
  )
